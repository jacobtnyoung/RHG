...
##### <ins> Terms/Phrases Pertaining to Wins/Loses <ins>  

*Championship*-A game played to no less than 25 to decide which of the opposing teams will have the winning record for the day. A game to 25 or more is worth 1.5 games.  
...
*NDA Champion*-When a team wins the last game, but ends the day with a losing record. Unlike a *Championship* or a *Fellowship* win, NDA Champions may only taunt, brag, or disclose their victory to those present on the court during the final game. 

*Shampionship*-When a team only wins the last game, with no other wins.

*Undefeated*-When a player wins every game they play on a specific day of hoop. Note, a player can go "undefeated" but cannot earn "Fellowship" if they do not participate in the first game played on a given day.  
...
#### <ins> Terms/Phrases Pertaining to "Checks" <ins>  
...
*Amphibious*-the ability to shoot poorly with both hands. 
...
*D&C/Duck and Chuck*-Keith's endearing phrase for Brandon's three-point shoot.
...
*Disappointment Checkdown*-the progressive decline of the tone, volume, and enthusiasm of your hooting (to get the ball) as you realize the teammate is continuing with the move you perceive to be of lesser value than passing to you, which is seen as the best-possible, if not perfect, play.
...
*FRick*-A **Rick** that is caused by a foul.

*Half FDR*-When a player requires a single knee brace.

*Good pass*-Said by a player who makes a marginal pass that ended up being converted into points by an amazing shot, whereupon the passer—in the jubilation—anonymously drops “good pass” into the congratulatory milieu hoping no one realizes it was the passer. Of course, now it is used by devotees to blatantly redirect the spotlight onto themselves after a modest or mediocre pass.

*Ill-advised*-Said after a shot is taken with questionable decision making.

*“I’m a maybe”*-A player might be able to play that day (unless used by Brandon in which case he is 100% in). Variants include “I need to know by [insert unreasonable time] if we are having a game because I am “[insert activity that is not work]”.
...
*Index game*-a game where Gerald and Keith were on opposite sides, and a win counted toward a monthly total of who was the superior player.
...
*Gerald*-Calling out any player who is shooting around and interferes with a game in progress.
...
*Samsonite*-When a player makes an egregious traveling violation.

*Shampionship*-The final game of the day where a winless team beats the undefeated team. Note: The Shampionship team typically makes a comment that only the final game of the day matters. The losing team typically makes a comment they were tired from playing so many games.
...
*The crowd boos the two pointer*-when making a three would’ve brought the score to 6-9.

*Timeout Mercury*-Statement made after a team goes on an early, extensive scoring run.
...
*We know*-The obligatory response when Brandon has made three or more “my bad” comments in a row after failures of various sorts on consecutive touches.
...
*Who’s next!*-A loud statement made at the end of a game by a winning player. No response is expected.
